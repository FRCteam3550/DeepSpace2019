...
public class DriveBaseSub extends Subsystem {
  ...
  private SpeedControllerGroup m_FrontSControlGroup;
  private SpeedControllerGroup m_BackSControlGroup;
  ...
  public DriveBaseSub() {
    ...
    m_FrontSControlGroup = new SpeedControllerGroup(m_LeftFrontMotor, m_RightFrontMotor);
    m_BackSControlGroup = new SpeedControllerGroup(m_LeftBackMotor, m_RightBackMotor);

    m_DiffDrive = new DifferentialDrive(m_FrontSControlGroup, m_FrontSControlGroup);
  ...
  public void stopRobot(){
    m_FrontSControlGroup.set(0);
    m_BackSControlGroup.set(0);
  }
